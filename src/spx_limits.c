...
static struct {
    ...
    int initialized;
} limits = {.max_stack_depth = SPX_DEFAULT_MAX_STACK_DEPTH,
...
{
    limits.max_stack_depth = parse_size_t_env("SPX_MAX_STACK_DEPTH", SPX_DEFAULT_MAX_STACK_DEPTH);

    limits.max_function_table_size =
        parse_size_t_env("SPX_MAX_FUNCTION_TABLE_SIZE", SPX_DEFAULT_MAX_FUNCTION_TABLE_SIZE);

    limits.reporter_buffer_size =
        parse_size_t_env("SPX_REPORTER_BUFFER_SIZE", SPX_DEFAULT_REPORTER_BUFFER_SIZE);
