...
static file_handler_t stdio_file_handler = {stdio_file_handler_open,  stdio_file_handler_dopen,
                                            stdio_file_handler_close, stdio_file_handler_flush,
                                            stdio_file_handler_print, stdio_file_handler_vprintf};

static file_handler_t gz_file_handler = {gz_file_handler_open,  gz_file_handler_dopen,
                                         gz_file_handler_close, gz_file_handler_flush,
                                         gz_file_handler_print, gz_file_handler_vprintf};

static spx_output_stream_t *create_output_stream(const file_handler_t *file_handler, void *file,
                                                 int owned)
{
    if (!file) {
        return NULL;
