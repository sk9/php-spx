...
static const spx_time_provider_t stub_time_provider = {.get_wall_time_ns = stub_get_wall_time_ns,
...
static const spx_memory_provider_t stub_memory_provider = {.get_stats = stub_memory_get_stats,
...
static const spx_io_provider_t stub_io_provider = {.get_stats = stub_io_get_stats,
...
static const spx_console_provider_t stub_console_provider = {.is_tty = stub_console_is_tty,
                                                             .supports_ansi =
                                                                 stub_console_supports_ansi,
...
static int stub_fs_get_info(const char *path, spx_file_info_t *info, int follow_symlinks,
                            spx_error_t *error)
{
    if (!path || !info) {
...
static int stub_fs_realpath(const char *path, char *resolved, size_t size, spx_error_t *error)
{
...
static const spx_fs_provider_t stub_fs_provider = {
    .get_info = stub_fs_get_info, .mkdir = stub_fs_mkdir, .realpath = stub_fs_realpath};
...
static const spx_platform_info_t stub_platform_info = {
    ...
    .capabilities = SPX_PLATFORM_CAP_WALL_TIME | SPX_PLATFORM_CAP_CPU_TIME | SPX_PLATFORM_CAP_TTY |
                    SPX_PLATFORM_CAP_ANSI_COLORS | SPX_PLATFORM_CAP_KQUEUE,
    .name = "FreeBSD",
    .version = NULL};
#elif defined(_WIN32)
static const spx_platform_info_t stub_platform_info = {
    ...
    .version = NULL};
#else
static const spx_platform_info_t stub_platform_info = {.type = SPX_PLATFORM_UNKNOWN,
                                                       .capabilities = SPX_PLATFORM_CAP_WALL_TIME,
                                                       .name = "Unknown",
                                                       .version = NULL};
#endif

static const spx_platform_t stub_platform = {.info = &stub_platform_info,
